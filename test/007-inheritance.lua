...
function test_Person ()
    ...
    assertInvokable( man.name )
    assertInvokable( man.force )
...
function test_Soldier ()
    ...
    assertTrue( soldier:isa(Person) )
    assertTrue( soldier:isa(man) )
    assertInvokable( soldier.name )
    assertInvokable( soldier.force )
...
function test_General ()
    ...
    assertInvokable( general.name )
    assertInvokable( general.force )
